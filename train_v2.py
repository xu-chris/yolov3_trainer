...
class Yolo(object):
    def __init__(self):
        ...
        self.yolo_model, self.yolo_body = self.create_model(yolo_weights_path='source/weights.h5')
    ...
    def create_model(self, load_pretrained=True, freeze_body=2,
                     yolo_weights_path='source/weights.h5'):
